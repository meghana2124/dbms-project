...
class PlacementModule(ctk.CTkFrame):
    def __init__(self, master, conn):
        super().__init__(master, fg_color="#2B3649")
        self.conn = conn
        
        # Title
        ctk.CTkLabel(self, text="Placement & Hiring (Company/Job Focus)", 
                     font=ctk.CTkFont(size=20, weight="bold"),
                     text_color="#00AEEF").pack(pady=(20, 10), padx=20)

        self.managed_tables = ['Company', 'Recruiter', 'recruiterEmail', 'PlacementOfficer', 'JobRole', 'placementOfficerEmail']
